...
class mainMenuDesigner:
    ...
    def __init__(self):
        ...
        #Botton opcion 1
        button_choice1=tk.Button(frame_buttons, text="1- Generar reporte", font=('Times',12), bd=0, bg='#9400D3', fg='#ffffff', command=lambda:self.report_device())
